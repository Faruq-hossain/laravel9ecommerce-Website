...
<head>
    <meta charset="utf-8">
<title>Bismillah Super Shop</title>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            {{-- check user authent or not --}}
                            @auth
                            <ul>                                
                                <li><i class="fi-rs-user"></i>{{ Auth::user()->name }} / 
                                    <form method="POST" action="{{ route('logout') }}"> 
                                        @csrf
                                        <a href="{{ route('logout') }}" onClick="event.preventDefault(); this.closest('form').submit();">Loguot</a>
                                    </form></li>
                            </ul>
                            @else
                            <ul>                                
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <p class="text-lg-end text-start font-sm text-muted mb-0">
                        &copy; <strong class="text-brand">BismillahSuperShop</strong> All rights reserved
                    </p>
                </div>
            </div>
        </div>
